...
const NotAssignedPage: React.FC = () => {
  ...
  // Filter tasks with status "notAssigned"
  const notAssignedTasks = tasks.filter((task) => task.status === "notAssigned");
